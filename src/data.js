export var categories = {
  ...
  convenience: {prefix: 'Grocerie with bulk aisle', iconUrl: require('../assets/img/icons/icon_convenience.png'), addOrganicSuffix: true, addBulkSuffix: false},
  ...
  bakery: {prefix: 'Bakerie', iconUrl: require('../assets/img/icons/icon_bakery.png'), addOrganicSuffix: true, addBulkSuffix: true},
  ...
  deli: {prefix: 'Delicatessen', iconUrl: require('../assets/img/icons/icon_deli.png'), addOrganicSuffix: true, addBulkSuffix: true},
  ...
  caterer: {prefix: 'Cartery', iconUrl: require('../assets/img/icons/icon_restaurant.png'), addOrganicSuffix: true, addBulkSuffix: true},
